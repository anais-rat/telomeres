...
LINEAGE_COUNT_ON_ALL_SIM = 1200 # 1200 seems good ratio error/time of computation.
...
def optimize_w_cmaes_multiple(par_bounds, sigma, cmaes_kwargs, popsizes,
    ...
    for i in range(run_count):
        ...
        while not optimizer.stop():
            ...
            # text_file = open("outcmaes/history.txt", "wb")
...
# text_file = open("outcmaes/history.txt", "rb")
...
def compute_n_plot_gcurves(point, kwarg, is_plotted=True, proc_count=1,
    ...
    ''' Function used by `good_fit` to plot the curves fitted.
