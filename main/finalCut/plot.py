...
if __name__ == "__main__":
    ...
    PAR_FINAL_CUT = {"idxs_frame": IDXS_FRAME, "delay": DELAY}  # [h]
    ...
    par_update = {"is_htype_seen": False, "fit": PAR}
    ...
    for key in KEYS:
        ...
        par_update = {
            "finalCut": deepcopy(par_final_cut),
            "is_htype_seen": False,
            "fit": PAR,
        }
