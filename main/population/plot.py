...
if FORMAT == 'manuscript':
    ...
    pd.plot_data_exp_concentration_curves_final(CSTAT_TELO_M['PD'],
                                                CSTAT_TELO_P['PD'], fig_dir,
                                                bbox_to_anchor=bbox_to_anchor1)
    pd.plot_data_exp_concentration_curves_final(CSTAT_TELO_M['c'],
                                                CSTAT_TELO_P['c'], None,
                                                bbox_to_anchor=bbox_to_anchor1)
    pd.plot_data_exp_concentration_curves_final(CSTAT_TELO_M['OD'],
                                                CSTAT_TELO_P['OD'], fig_dir,
...
if FORMAT == 'manuscript':
    parp.plot_distributions_shortest_min(CELL_COUNTS, fig_supdirectory=fig_dir)
...
# pp.plot_p_pfixed(CELL_COUNTS, SIMU_COUNTS, {'day_count': DAY_PLOTTED_COUNT_B},
#                  {'day_count': DAY_PLOTTED_COUNT_SEN}, fig_dir, xticks=XTICKS,
